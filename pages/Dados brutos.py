...
# criando funcao para converter o dataframe em arquivo csv no momento do download
@st.cache_data #armazena o df no cache 
def converte_csv(df):
...
response = requests.get(url) # passando parametro para carregar os filtros
...
# filtrando colunas para identificar quais vao ficar na base de dados
...
# construindo filtragens para os filtros funcionarem
query = '''
